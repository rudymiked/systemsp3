...
{
       0,    41,    41,    42,    47,    48,    49,    57,    65,    73,
      83,    97,   103,   111,   112,   113,   116,   117
};
#endif
...
{
  "$end", "error", "$undefined", "NEWLINE", "DEFPROMPT", "CD", "ASSIGNTO",
  "LISTJOBS", "BYE", "BG", "RUN", "STRING", "VARIABLE", "METACHAR", "WORD",
  "$accept", "shell", "cmd", "stmt", "arglistcmd", YY_NULLPTR
};
#endif
...
{
      -1,    -2,    -5,    -3,    -4,     7,    -5,    -5,    11,     8,
      12,    -5,    27,    10,    25,    -5,    -5,    -5,    -5,    15,
      18,    20,    -5,    -5,    -5,    -5,    21,    -5,    -5,    23,
      -5
};
...
{
       0,     0,     5,     0,     0,     0,    11,    13,     0,     0,
       0,    14,     0,     0,     2,    15,     6,     7,    12,     0,
      16,     0,     8,     1,     3,     4,     0,    17,     9,     0,
      10
};
...
{
       1,    16,     2,     3,     4,     5,     6,     7,    17,     8,
      18,     9,    10,    11,     3,     4,     5,     6,     7,    19,
       8,    21,     9,    10,    11,    20,    22,    23,    25,    26,
      27,    28,    24,    29,    30
};

static const yytype_uint8 yycheck[] =
{
       1,     3,     3,     4,     5,     6,     7,     8,    11,    10,
      14,    12,    13,    14,     4,     5,     6,     7,     8,    12,
      10,    13,    12,    13,    14,    14,    14,     0,     3,    14,
      12,    11,    13,    12,    11
};
...
static const yytype_uint8 yystos[] =
{
      ...
      13,    14,    16,    17,    18,    19,     3,    11,    14,    12,
      14,    13,    14,     0,    18,     3,    14,    12,    11,    12,
      11
};
...
#line 47 "parser.y" /* yacc.c:1646  */
    { call(NEWLINE, NULL, NULL, NULL, NULL); }
...
#line 57 "parser.y" /* yacc.c:1646  */
    {	
							...
							call(DEFPROMPT, (yyvsp[0].string), NULL, NULL, NULL);	}
...
#line 65 "parser.y" /* yacc.c:1646  */
    {	
							...
							call(METACHAR, (yyvsp[0].word), NULL, NULL, NULL);	}
...
#line 73 "parser.y" /* yacc.c:1646  */
    {	
							...
							call(VARIABLE, (yyvsp[0].string), (yyvsp[-1].mchar), NULL, NULL); 	}
...
#line 83 "parser.y" /* yacc.c:1646  */
    {	
							...
							call(ASSIGNTO, (yyvsp[0].string), (yyvsp[-1].var), (yyvsp[-2].word), (yyvsp[-3].var)); 	}
...
#line 103 "parser.y" /* yacc.c:1646  */
    {
					if(ShowTokens)
			                   ...
			                   printf("Token type = Word\t Token = %s\t Usage = directory_name\n", (yyvsp[0].word));
		                        ...
		                        call(CD, (yyvsp[0].word), NULL, NULL, NULL);		}
...
#line 116 "parser.y" /* yacc.c:1646  */
    { call(RUN, (yyvsp[0].word), NULL, NULL, NULL); }
...
#line 117 "parser.y" /* yacc.c:1646  */
    {
                                      ...
                                      call(RUN, (yyvsp[0].var), (yyvsp[-1].word), NULL, NULL);
                                }
